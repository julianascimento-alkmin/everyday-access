...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Serviço Sem Fila" },
      { property: "og:title", content: "Serviço Sem Fila" },
      { property: "og:description", content: "Guia simples para acessar serviços públicos digitais." },
